...
/*   Updated: 2026/01/26 18:21:39 by schahir          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
AForm::AForm(std::string name, const int tosign, const int toexecute):_name(name), _signed(false), _tosign(tosign), _toexecute(toexecute)
{
    ...
    std::cout << "new " << _name << " Aform created  status: not signed, grades to sign: " << _tosign << " grades to be executed " << _toexecute << "." << std::endl;
}
